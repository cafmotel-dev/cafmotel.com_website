		...
		<div class="forms-container">
			<div class="signin-signup">
				...
				<form action="{{url('store')}}"class="sign-up-form"method="post">
                    @csrf
					<h2 class="title"id="sign_up">Sign up</h2>
					...
					<div class="input-field">
						<i class="fas fa-lock"></i>
                        <input type="password" id="password" placeholder="Enter your Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?=.*\w).{6,}" title="Password must be at least 6 characters long and include at least one uppercase letter, one lowercase letter, one number, one special character, and no spaces" required />					</div>
		
				
          <input type="submit" value="Submit" id="submitPhone" class="btn solid" />
